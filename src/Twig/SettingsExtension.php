...
class SettingsExtension extends AbstractExtension
{
    ...
    public function getFunctions()
    {
        return [
            ...
            new TwigFunction("get_company_hours", [$this, "getCompanyHours"], [
                "is_safe" => ["html"],
            ]),
    ...
    public function companySettings(): Setting
    {
        return $this->entityManager->getRepository(Setting::class)->findOneBy([]);
    }

    public function getCompanyHours(): string
    {
        ...
        return $this->environment->render("@Company/twig/hours.html.twig", [
     ...
     */
    public function getGoogleReview(): ?array
    {
        $setting = $this->entityManager->getRepository(Setting::class)->findOneBy([]);
